          ...
          <div className="overflow-hidden">
            ...
            >
              {featuredProducts?.map((product) => (
                ...
                >
                  <div className="bg-emerald-950 bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-emerald-500/30">
                    <div className="overflow-hidden">
                      <img
                        src={product.image}
                        alt={product.name}
